...
<script src="login_server.js"></script>
  ...
  <form method="post" action="login.php" class="modal-content">
    ...
    <div class="container">
      ...
      <div class="msg-holder" id="error-msg-holder">
        <p class="msg" id="error-msg"><i class="fa-solid fa-exclamation"></i> Invalid username <span id="error-msg-second-line">and/or password</span></p>
      </div>
    ...
    <div class="bottomcontainer" style="background-color:#f1f1f1">
      <span class="membership"><a href="registration_form.html">Create yours.</a></span>
